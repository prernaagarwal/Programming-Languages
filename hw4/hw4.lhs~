...
> data UserID = UserIDString String | UserIDInt Int Int
...
> data AudioStream = AudioStreamString String | AudioStreamList [Float]
...
>   \x ->
>     case x of
>       JSONInt i -> JSONString (show i)
>       JSONString s -> JSONString (s)
>       JSONFloat f -> JSONString (show f)
...
>   \x ->
>     case x of
>       UserIDString s -> JSONString (s)
>       UserIDInt i j -> JSONInt (i + j)
