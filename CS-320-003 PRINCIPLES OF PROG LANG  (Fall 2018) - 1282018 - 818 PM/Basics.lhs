This is the script I wrote out for the Haskell lecture on Wednesday 9/26, with
added commentary for clarification. It's structured a little differently than
what I ended up presenting - all the content is in this one file instead of
split across Bool.hs and Basics.hs - but it has all the same information and a
bit more.
